...
<div class="container">
    <div class="content">
        <article class="media">
        <h1 class="media-content">Collie</h1>
        ...
        <h2>Hälsa</h2>
        <p>
        Collie ligger sammantaget på en medelnivå när det gäller skadestatistik, men Collie Eye Anomaly (CEA) och colobom (ögonsjukdomar) och höftledsdysplasi (HD) förekommer. Rasen finns med i de Särskilda Rasspecifika Domaranvisningarna (SRD) för riskområden som alltför små djupt liggande ögon, felställda hörntänder och ängslig mentalitet.
        </p>
